...
3. If llms.txt references another document, open that URL with the available web or documentation tool.
4. Do not start with broad web search; follow the llms.txt links first.
