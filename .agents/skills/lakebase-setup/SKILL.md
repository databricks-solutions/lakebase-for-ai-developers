...
See `.agents/skills/add-tools/examples/lakebase.yaml` for the YAML snippet.
...
See `.agents/skills/add-tools/examples/lakebase-autoscaling.yaml` for the YAML snippet.
